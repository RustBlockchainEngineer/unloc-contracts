...
import {UnlocStaking, IDL} from '../../src/types/unloc_staking';
import { TOKEN_PROGRAM_ID, Token, ASSOCIATED_TOKEN_PROGRAM_ID } from "@solana/spl-token";
const { web3, BN, AnchorProvider } = anchor
...
// test wallet UNLOC devnet token account - 8An73xfHatDuRknJ9UPadMAymRpkhQHiV8Safkh71UEx
const MAIN_POOL_CONFIG = {
  ...
  FUND_AMOUNT: new BN(1000000 * 1_000_000), // 1000 UNLOC token
  REWARD_CONFIGS: [
...
export const STAKING_CONFIG = MAIN_POOL_CONFIG

const program = new anchor.Program<UnlocStaking>(IDL, STAKING_CONFIG.PROGRAM_ID);
