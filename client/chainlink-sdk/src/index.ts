...
export const CHAINLINK_AGGREGATOR_PROGRAM_ID = new anchor.web3.PublicKey(
  "cjg3oHmg9uuPsP8D6g29NWvhySJkdYdAo9D25PRbKXJ"
);
export const CHAINLINK_STORE_PROGRAM_ID = new anchor.web3.PublicKey(
  "HEvSKofvBgfaexv23kMabbYqxasxU3mQ4ibBMEmJWHny"
);

export interface Round {
  feed: anchor.web3.PublicKey;
  answer: BN;
  roundId: number;
  observationsTS: Date;
...
export class OCR2Feed {
  ...
  static async load(
    programID: anchor.web3.PublicKey = CHAINLINK_AGGREGATOR_PROGRAM_ID,
  ...
  public onRound(feed: anchor.web3.PublicKey, callback: (round: Round) => void): number {
