...
pub mod unloc_voting {
    ...
    pub fn set_global_state(ctx: Context<SetGlobalState>, new_super_owner: Pubkey, staking_pid: Pubkey) -> Result<()> { 
        process_set_global_state(ctx, new_super_owner, staking_pid)
    }
