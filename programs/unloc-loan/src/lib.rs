...
pub mod unloc_loan {
    ...
    pub fn set_global_state(ctx: Context<SetGlobalState>, accrued_interest_numerator: u64, denominator: u64, apr_numerator: u64, reward_per_sol: u64, reward_per_usdc: u64, unloc_staking_pid: Pubkey, unloc_staking_pool_id: Pubkey, voting_pid: Pubkey, current_voting_num: u64) -> Result<()> { 
        process_set_global_state(ctx, accrued_interest_numerator, denominator, apr_numerator, reward_per_sol, reward_per_usdc, unloc_staking_pid, unloc_staking_pool_id, voting_pid, current_voting_num)
    }
