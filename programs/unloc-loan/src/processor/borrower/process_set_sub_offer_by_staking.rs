...
pub fn handle<'a, 'b, 'c, 'info>(ctx: Context<'a, 'b, 'c, 'info, SetSubOfferByStaking<'info>>, offer_amount: u64, sub_offer_number: u64, loan_duration: u64, apr_numerator: u64) -> Result<()> { 
    ...
    set_sub_offer(set_sub_offer_ctx, offer_amount, sub_offer_number, loan_duration, apr_numerator, profile_level)
}

#[derive(Accounts)]
#[instruction(offer_amount: u64, sub_offer_number: u64, loan_duration: u64, apr_numerator: u64)]
